...
void Controller_Game::runGame() {
    ...
    //cambiao
    controllerEnemies.push_back(std::make_unique<Controller_Enemy>(gameModel.modelEnemy, gameView.viewEnemy, players, collisionEnemies[0])); // se le puede asignar de mejor manera
    controllerEnemies.push_back(std::make_unique<Controller_Enemy>(gameModel.modelEnemy2, gameView.viewEnemy2, players, collisionEnemies[1]));  //este tambien
